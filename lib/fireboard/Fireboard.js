...
//         console.log(`Connected: ${JSON.stringify(connection, null, 4)}`); 
//     }],
//     interfaceFilters: {
//         // interface: ['br0'],
//         internal: [false],
...
class Fireboard extends EventEmitter {
    ...
    updateChannels() {
        console.log('updateChannels', this.#device.channels, this.#channels);
        const updates = {};
    ...
    pingLocal() {
        ...
        this.doPing2();
        this.#pingIntervalId = setInterval(this.doPing2, this.#cfg.devicePingInterval);
    }
